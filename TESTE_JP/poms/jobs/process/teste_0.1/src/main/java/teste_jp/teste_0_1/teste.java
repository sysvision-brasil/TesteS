...
public class teste implements TalendJob {
	static {System.setProperty("TalendJob.log", "teste.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(teste.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_7nVSgPs4Ee2-QIhvkc9Hxg", "0.1");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_TESTE_JP_teste = new byte[0];
    static byte[] commonByteArray_TESTE_JP_teste = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TESTE_JP_teste.length) {
				if(length < 1024 && commonByteArray_TESTE_JP_teste.length == 0) {
   					commonByteArray_TESTE_JP_teste = new byte[1024];
				} else {
   					commonByteArray_TESTE_JP_teste = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TESTE_JP_teste, 0, length);
			strReturn = new String(commonByteArray_TESTE_JP_teste, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TESTE_JP_teste, 0, length);
			strReturn = new String(commonByteArray_TESTE_JP_teste, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TESTE_JP_teste) {
...
public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"nome","numero",});        
...
class tRowGenerator_1Randomizer {
	public String getRandomnome() {
		...
		return DataQuality.getLastName("Mrs. Marty Smith III" );
	...
	for (int itRowGenerator_1=0; itRowGenerator_1<nb_max_row_tRowGenerator_1 ;itRowGenerator_1++) {
		...
		row1.numero = randtRowGenerator_1.getRandomnumero();
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'teste' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_7nVSgPs4Ee2-QIhvkc9Hxg");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-05-25T20:25:29.437132500Z");
        ...
        try {
            ...
            java.io.InputStream inContext = teste.class.getClassLoader().getResourceAsStream("teste_jp/teste_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = teste.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'teste' - Started.");
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'teste' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     61657 characters generated by Talend Real-time Big Data Platform 
 *     on the 25 de maio de 2023 17:25:29 BRT
 ************************************************************************************************/