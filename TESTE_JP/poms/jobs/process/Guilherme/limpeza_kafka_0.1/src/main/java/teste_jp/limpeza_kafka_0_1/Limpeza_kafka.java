...
public class Limpeza_kafka implements TalendJob {
	static {System.setProperty("TalendJob.log", "Limpeza_kafka.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Limpeza_kafka.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_p7zeQPpvEe2EusXe7keuYw", "0.1");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileDelete_1{
                    ...
                    log4jParamters_tFileDelete_1.append("Parameters:");
                            log4jParamters_tFileDelete_1.append("PATH" + " = " + "((String)globalMap.get(\"tFileList_1_CURRENT_FILEPATH\"))");
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'Limpeza_kafka' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-05-30T13:17:18.223828300Z");
        ...
        try {
            ...
            java.io.InputStream inContext = Limpeza_kafka.class.getClassLoader().getResourceAsStream("teste_jp/limpeza_kafka_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Limpeza_kafka.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("caminho_logs")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Limpeza_kafka");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     73670 characters generated by Talend Real-time Big Data Platform 
 *     on the 30 de maio de 2023 10:17:18 BRT
 ************************************************************************************************/